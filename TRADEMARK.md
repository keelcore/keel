...
The Keel name is a guarantee of a 2MB standalone footprint and a fail-closed FIPS posture. Governance of the name ensures
that forks or downstream distributions do not dilute these core architectural requirements.
